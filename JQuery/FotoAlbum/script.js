...
$('#actPic').css( { "width": "440px", "box-shadow": "0 0 15px 9px #369" } )
$('#bigPic').append(' <div id="actTxt" /> ')
$('#actTxt').css( { "position": "absolute", "bottom": "0px", "left": "100px", "width": "420px", "height": "50px", "background": "black", "background": "rgba(0, 0, 0, 0.6)", "color": "#bbb", "padding": "10px", "font": "bold 10px Verdana" } )
$('#actTxt').append(' <h1></h1> ')
$('h1').css('margin', '0')
...
for (let i = 1; i < pics.length; i++) {
    ...
    $('.smallPic').css( { "margin": "15px", "box-shadow": "0 0 15px 10px #369", "width": "120px" } )
    $('.smallPic').hover(
